import { CatecoryMain } from "@/components/shared/categories/catecoryMain";
import { BiSolidCategory } from "react-icons/bi";

export default async function Categories() {
  return (
    <div className="mt-[clamp(1.875rem,1.445rem+2.15vw,3.125rem)] pb-[30px] mx-[clamp(0.938rem,calc(-15.104rem+23.33vw),3.125rem)] max-[650px]:mx-0 flex flex-col items-center justify-center flex-1">
