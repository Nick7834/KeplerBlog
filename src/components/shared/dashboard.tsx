...
export const Dashboard: React.FC<Props> = ({ className }) => {
  ...
  return (
    ...
    >
      <Link
        href="/"
        className='relative flex items-center w-fit text-[#848484] dark:text-[#e3e3e3] text-5xl font-medium font-["Protest_Guerrilla"]'
      >
        {isInSeason && (
          <Image
            src="/year.png"
            width={50}
            height={50}
            className="absolute -top-[14px] -left-[18px]"
            alt="avatar"
          ></Image>
        )}
      ...
      <p className="mt-auto text-[#797d7e] dark:text-[#e3e3e3] text-sm text-center font-medium">
