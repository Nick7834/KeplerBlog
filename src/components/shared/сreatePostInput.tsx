    ...
    <div className={cn("flex flex-col max-w-[600px]", className)}>
      ...
      <div className="create-post-button flex flex-col items-end justify-end mt-[30px] ml-auto w-full max-w-[125px]">
        <Button
          loading={loading}
          onClick={handlePost}
          disabled={title.length === 0 || !categories ? true : false}
          className="w-full px-[30px] flex items-center justify-center text-[#d9d9d9] dark:text-[#333333] bg-[#333333] dark:bg-[#d9d9d9] hover:bg-[#333333]/85 dark:hover:bg-[#d9d9d9]/85"
        >
          <MdCreate className="block translate-y-[-1px]" /> Create
        </Button>
      </div>
    </div>
  );
